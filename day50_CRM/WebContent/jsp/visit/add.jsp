...
<script type="text/javascript">
	...
	function changeCustomer() {
		...
		$.post(url,{"cid":cid},function(result){
			//alert("result"+result);
			//清空旧的数据  ajax 给某一个标签赋值， 有以下几种写法 
			//val("aa")  value属性  text("") 文本 <>dadfsdfa<> html("") 替换以前的内容   append("") 追加内容
			$("#linkMan").html("<option value=''>请选择</option>");
			$(result).each(function(i,n){//n其实就是联系人对象
				...
				<tr>
					...
					<td vAlign=top width="100%" bgcolor="#ffffff">
						...
						<table cellspacing="0" cellpadding="5" border="0">
							<tr>
								<td>客户名称：</td>
								<td><select onchange="changeCustomer()" id="customer" name="customer.cust_id" class="textbox"
							...
							<tr>
								<td>被拜访人：</td>
								<td>
								<select id="linkMan" name="linkMan.lkm_id" class="textbox"
									style="width: 180px; height: 21px;">
										<option value="">请选择</option>
								</td>
								<td>拜访地点：</td>
