...
<SCRIPT language=javascript>
	...
	function loadDict(type_code , tagId,oldVal){
		...
		$.post(url , {"dict_type_code" :type_code } , function(result){
			...
			/* var oldVal="${cust_level.dict_id}"
			var oldVal="${cust_industry.dict_id}"
			var oldVal="${cust_source.dict_id}" */
			...
			//选中该选中的option(方法二：)  在指定的id标签身上找option标签， 按照value值来找，如果找到了就修改这个option标签的属性，修改selected属性，值为selected
									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>客户名称：</TD>
													<td><s:textfield class="textbox" id="sChannel2" style="WIDTH: 100px" maxLength="50" name="cust_name"/></td>
													...
													<TD>联系电话：</TD>
													<TD><s:textfield class="textbox" id="sChannel2" style="WIDTH: 100px" maxLength="50" name="cust_phone"/></TD>
